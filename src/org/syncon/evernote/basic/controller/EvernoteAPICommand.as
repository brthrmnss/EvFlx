...
*/
		...
		private function listNotebooksResultHandler(e:EvernoteServiceEvent)  : void
		{
			if ( seqId != this.service.getSequenceNumber()) return; 
			if ( this.event.fxSuccess != null ) this.event.fxSuccess(e.data);
			this.apiModel.loadNotebooks( e.data as Array ) 
			this.deReference(e)			
		}		
		...
		private function listTagsResultHandler(e:EvernoteServiceEvent)  : void
		{
			if ( seqId != this.service.getSequenceNumber()) return; 
			if ( this.event.fxSuccess != null ) this.event.fxSuccess(e.data);
			this.apiModel.loadTags( e.data as  Array )
			this.deReference(e)			
		}		
		...
		private function deReference(e:Object=null) : void
		{
			...
			{
				/*
				var event_ :  EvernoteAPICommandResultEvent = 
					new EvernoteAPICommandResultEvent( e.type, e.data, this.seqId, 
							this.event.tokenData, this.event.tokenDate )
