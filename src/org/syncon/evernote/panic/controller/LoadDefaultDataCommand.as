	...
	public class LoadDefaultDataCommand extends Command
	{
		...
		//	board.horizontalGap = 10; 
			...
			*/
			...
			var projects : Array = []; 
			projects.push( new ProjectVO('Transmit', 'coda is coda', '', '', [], 'http://www.veryicon.com/icon/32/Application/Office%20Round/Microsoft%20Project.png', this.randSet( 4,0, people, 'id' ) ) ) 
			projects.push( new ProjectVO('Unision', 'coda is coda', '', '', [], 'a.jpg', this.randSet( 8,0, people, 'id' ) ) ) 
			projects.push( new ProjectVO('Coda', 'coda is coda', '', '', [], 'http://www.veryicon.com/icon/32/Application/Office%20Round/Microsoft%20Project.png', this.randSet( 4,0, people, 'id' ) ) ) 
			projects.push( new ProjectVO('Twitter', 'coda is coda', '', '', [], 'gif/A01 copy.gif"', this.randSet( 12,0, people, 'id' ) ) ) 
			projects.push( new ProjectVO('Reddit', 'coda is coda', '', '', [], 'a.jpg', this.randSet( 4,0, people, 'id' ) ) ) 
			projects.push( new ProjectVO('Ipad', 'coda is coda', '', '', [], 'a.jpg', this.randSet( 4,0, people, 'id' ) ) ) 
			projects.push( new ProjectVO('Dell', 'coda is coda', '', '', [], 'a.jpg', this.randSet( 4,0, people, 'id' ) ) ) 
			projects.push( new ProjectVO('Tekken', 'coda is coda', '', '', [], 'a.jpg', this.randSet( 4,0, people, 'id' ) ) ) 
			projects.push( new ProjectVO('Smurf', 'coda is coda', '', '', [], 'a.jpg', this.randSet( 4,0, people, 'id' ) ) ) 
			projects.push( new ProjectVO('J++', 'coda is coda', '', '', [], 'a.jpg', this.randSet( 4,0, people, 'id' ) ) ) 				
