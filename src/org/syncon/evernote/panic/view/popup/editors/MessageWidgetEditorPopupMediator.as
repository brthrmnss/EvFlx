package  org.syncon.evernote.panic.view.popup.editors
{
	...
	public class MessageWidgetEditorPopupMediator extends Mediator
		implements IWidgetEditorMediator
	{
		[Inject] public var ui:MessageWidgetEditorPopup;
		...
		{
			var d : WidgetVO = MessageWidget.importData( this.data.name, this.data.description, 
